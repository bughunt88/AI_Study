...
total_data = np_load = np.load('./samsung/samsung_data.npy')
...
'''
model = Sequential()
model.add(Conv1D(filters=64, kernel_size=(2), padding='same', input_shape=(x_train.shape[1], x_train.shape[2]), activation='relu'))
