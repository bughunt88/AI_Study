...
transfer = ResNet50(weights='imagenet', include_top=False,input_shape=(32,32,3))
...
#loss :  [1.0077141523361206, 0.6568999886512756]
...
_________________________________________________________________
batch_normalization (BatchNo (None, 1, 1, 2048)        8192
_________________________________________________________________
activation (Activation)      (None, 1, 1, 2048)        0
_________________________________________________________________
...
Trainable params: 275,658
Non-trainable params: 23,592,192
_________________________________________________________________
'''
