...
print(xy_train)
# <tensorflow.python.keras.preprocessing.image.DirectoryIterator object at 0x00000222208C77F0>
print(xy_train[0])

# x 값 
print(xy_train[0][0].shape) # (5,150,150,3)
# y 값 
print(xy_train[0][1].shape) # [1,0,0,0,0,]


np.save('../data/image/brain/npy/kerass66_train_x.npy', arr=xy_train[0][0])
np.save('../data/image/brain/npy/kerass66_train_y.npy', arr=xy_train[0][1])
np.save('../data/image/brain/npy/kerass66_test_x.npy', arr=xy_test[0][0])
np.save('../data/image/brain/npy/kerass66_test_y.npy', arr=xy_test[0][1])
