...
for n in n_jobs_list:
    ...
    #2. 모델
    model = XGBClassifier(n_jobs=n, eval_metric='mlogloss')
    ...
    print('n_jobs = ',n,' 걸린 시간 : ', total_time)
...
# n_jobs = -1  걸린 시간 :  0:00:00.067790
# n_jobs = 8  걸린 시간 :  0:00:00.035905
# n_jobs = 4  걸린 시간 :  0:00:00.031914
# n_jobs = 1  걸린 시간 :  0:00:00.054853
