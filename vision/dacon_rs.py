...
parameters = [
    {"n_estimators" : [500], "learning_rate":[0.1,0.001,0.01], "max_depth":[4,5,6],"colsample_bytree":[0.6,0.8,1], "colsample_bylevel":[0.6,0.7,0.9]}
...
model = RandomizedSearchCV(XGBClassifier(n_jobs = 8), parameters, cv=kfold)
