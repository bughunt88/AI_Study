...
x1_train, x1_test, y1_train, y1_test, x2_train, x2_test, y2_train, y2_test, y3_train, y3_test  = train_test_split(x1, y1, x2, y2, y3, shuffle=False, train_size=0.8) # shuffle False면 섞는다
...
model.fit([x1_train,x2_train], [y1_train,y2_train, y3_train], epochs=10, batch_size=1, validation_split=0.2, verbose=1)
...
model3_r2 = r2_score(y3_test , y3_predict)
r2 = (model1_r2 + model2_r2 + model3_r2)/3
...
x_predict4  = np.array([[201,511,200]])


y_test = model.predict([x_predict3,x_predict4])
