# 실습 validatrion 데이터를 만들 것!!!
# 슬라이싱 하지 말고 train_test_split을 사용할 것 
...
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.2, shuffle=True) # shuffle=False 은 순서 섞지 말고 나오도록 하는 함수 , 섞고 싶으면 True, 기본 값은 트루이다
