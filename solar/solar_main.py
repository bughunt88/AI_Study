...
for q in q_lst:
  ...
  model.fit(X_train_1,Y_train_1, epochs=10, validation_data=(X_valid_1,Y_valid_1),callbacks=[early_stopping])
...
print(np.array(predict_list).shape)
...
loss = model.evaluate(X_valid_1, Y_valid_1, batch_size=8)
