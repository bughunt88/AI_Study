...
for op_idx,opti in enumerate(opti_list):
    for ac_idx,acti in enumerate(acti_list):
        ...
        for train_index, test_index in kfold.split(x_train):             
            ...
            filepath_cp = f'../data/modelcheckpoint/15_models_compare_{op_idx}_{ac_idx}_fold' + str(num) + '.hdf5'
            model = load_model(filepath_cp, custom_objects={'leaky_relu':leaky_relu, 'mish':mish}, compile = False)
