...
for op_idx,opti in enumerate(opti_list):
    for ac_idx,acti in enumerate(acti_list):
        modelpath = f'../data/modelcheckpoint/15_models_compare_w_{op_idx}_{ac_idx}.hdf5'
        ...
        df.to_csv(f'../data/modelcheckpoint/15_models_compare_w_{op_idx}_{ac_idx}.csv',index=False)
