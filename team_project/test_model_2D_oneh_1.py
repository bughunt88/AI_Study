...
for train_index, test_index in kfold.split(x_train): 
    ...
    model.add(Conv2D(filters=1024, kernel_size=(2,2), padding='same',
                    strides=(2,2) , input_shape=(x_train.shape[1],1,1), activation=leaky_relu))
    ...
    modelpath = '../data/modelcheckpoint/team_2d_1_'+str(num)+'.hdf5'
...
r2 :  [0.999647431855938, 0.9998550445528157, 0.9999296705239347]
RMSE :  [0.0039111862844220064, 0.002507865474330131, 0.0017468501743889248]
70613.733227초 걸렸습니다.
'''
